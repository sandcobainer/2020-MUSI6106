...
//    TEST_FIXTURE(DtwData, getMinCost)
//    {
//        m_aiMatrixDimension[0] = 5;
//        m_aiMatrixDimension[1] = 4;
//
...
//        m_pCDtw->init(m_aiMatrixDimension[0], m_aiMatrixDimension[1]);
//
//        CHECK_EQUAL(-1, m_pCDtw->getMinCost(4, 4.5, -1));
//        CHECK_EQUAL(-4, m_pCDtw->getMinCost(-4, 4.5, -1));
//        CHECK_EQUAL(0, m_pCDtw->getMinCost(4, 0, 0));
//        CHECK_EQUAL(4, m_pCDtw->getMinCost(4, 4, 4));
//    }
